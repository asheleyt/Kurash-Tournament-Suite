<template>
    <div class="animate-in duration-150 fade-in slide-in-from-right-2">
        <div
            class="rounded-3xl border border-white/8 bg-white/[0.035] p-5 shadow-[0_24px_80px_-58px_rgba(15,23,42,0.92)]"
        >
            <div
            ...
            >
                <div>
                    <h3
                        class="text-lg font-black tracking-[0.16em] text-white uppercase"
                    >
                        Local Display Roles
                    </h3>
                    <p class="mt-1 max-w-2xl text-sm text-slate-400">
                        Choose which screens show the public Scoreboard and
                        Gilam Match Order.
                    </p>
                </div>
                <div
                    class="flex flex-wrap items-center gap-2 text-[10px] font-black tracking-[0.2em] uppercase"
                >
                    <span
                        class="rounded-full border px-3 py-1"
                        :class="
                            model.isDisplayManagementAvailable
                    ...
                    <span
                        class="rounded-full border border-white/10 bg-black/20 px-3 py-1 text-slate-300"
                    >
                        {{
                            model.displayActionPending
                                ? 'Refreshing'
                                : `${model.detectedDisplays.length} Screen${model.detectedDisplays.length === 1 ? '' : 's'} Detected`
                        }}
                    </span>
                </div>
            </div>
            ...
            >
                Screen controls are available only in the Electron desktop app.
                In the browser preview, the page will use normal browser window
                behavior.
            </div>

            <template v-else>
                <div
                    class="mt-5 rounded-3xl border border-white/7 bg-black/16 p-4"
                >
                    <div
                    ...
                    >
                        <div>
                            <div class="flex flex-wrap items-center gap-2">
                                <span
                                    class="rounded-full border border-blue-500/30 bg-blue-500/10 px-3 py-1 text-[10px] font-black tracking-[0.2em] text-blue-100 uppercase"
                                    >Step 1</span
                                >
                                <div
                            ...
                            <div class="mt-2 text-sm text-slate-400">
                                Choose how Scoreboard and Gilam Match Order
                                should use public screens.
                            </div>
                        </div>
                        <div
                            class="grid grid-cols-1 gap-3 sm:grid-cols-2 xl:min-w-lg"
                        >
                            <button
                                @click="
                                    actions.setScoreboardOutputMode('single')
                                "
                                :disabled="
                                    model.displayActionPending ||
                                    model.isScoreboardLive ||
                                    model.isDisplayTestActive ||
                                ...
                                :class="
                                    !model.isBroadcastMode
                                        ? 'border-blue-500/40 bg-blue-500/10 text-white shadow-[0_18px_45px_-30px_rgba(37,99,235,0.95)]'
                                        : 'border-white/8 bg-white/3 text-slate-300 hover:bg-white/5'
                                "
                            >
                                <div
                                    class="text-sm font-black tracking-[0.18em] uppercase"
                                >
                                    Single Screen
                                </div>
                                <div class="mt-1 text-xs text-slate-400">
                                    Limit each public role to one selected
                                    screen.
                                </div>
                            </button>
                            <button
                                @click="
                                    actions.setScoreboardOutputMode('broadcast')
                                "
                                :disabled="
                                    model.displayActionPending ||
                                    model.isScoreboardLive ||
                            ...
                            >
                                ...
                                <div class="mt-1 text-xs text-slate-400">
                                    Allow each public role on several selected
                                    screens.
                                </div>
                            </button>
                        </div>
                ...
                <div
                    class="mt-4 rounded-3xl border border-white/7 bg-black/14 px-4 py-3"
                >
                    <div class="flex flex-col gap-3">
                            ...
                            <div>
                                <div class="flex flex-wrap items-center gap-2">
                                    <div
                                        class="text-[10px] font-black tracking-[0.2em] text-slate-500 uppercase"
                                    >
                                        Saved Display Setups
                                    </div>
                                    <span
                                        class="rounded-full border border-white/8 bg-black/16 px-3 py-1 text-[10px] font-black tracking-[0.2em] text-slate-400 uppercase"
                                        >Optional</span
                                    >
                                    <span
                                        class="rounded-full border border-emerald-500/20 bg-emerald-500/10 px-3 py-1 text-[10px] font-black tracking-[0.2em] text-emerald-100 uppercase"
                                        >Recovery</span
                                    >
                                </div>
                                <div class="mt-1 text-sm text-slate-400">
                                    Save and reapply common venue layouts after
                                    a restart or screen changes.
                                </div>
                            </div>
                            <div
                                class="max-w-md text-[11px] leading-5 text-slate-500"
                            >
                                Reuse common venue layouts without rebuilding
                                the selection and recover faster when screens
                                disappear or return.
                            </div>
                        </div>

                        <div
                            class="grid grid-cols-1 gap-2 xl:grid-cols-[minmax(0,1.15fr)_auto_auto_minmax(0,0.95fr)_auto]"
                        >
                            <DropdownMenu>
                                <DropdownMenuTrigger as-child>
                                    <button
                                        ...
                                        :disabled="
                                            model.displayActionPending ||
                                            !model.broadcastProfiles.length
                                        "
                                        class="flex h-11 w-full items-center justify-between rounded-xl border border-white/8 bg-white/4 px-4 py-3 text-white transition-all outline-none focus:border-green-500/50 focus:ring-2 focus:ring-green-500/20 disabled:cursor-not-allowed disabled:opacity-50"
                                    >
                                        <span
                                            :class="[
                                                'font-bold',
                                ...
                                >
                                    <DropdownMenuItem
                                        ...
                                        :key="profile.id"
                                        @select="
                                            actions.setSelectedBroadcastProfileId(
                                                String(profile.id),
                                            )
                                        "
                            ...
                            <button
                                ...
                                :disabled="
                                    model.displayActionPending ||
                                    !model.selectedBroadcastProfileId ||
                                    model.isScoreboardLive ||
                                    model.isDisplayTestActive ||
                                    model.isRingMatchOrderLive ||
                                    model.isRingMatchOrderPreviewActive
                                "
                                class="h-11 rounded-xl border border-blue-500/30 bg-blue-500/10 px-4 text-sm font-black tracking-[0.18em] text-blue-100 uppercase transition hover:bg-blue-500/20 disabled:cursor-not-allowed disabled:opacity-50"
                            >
                                Reapply
                            </button>
                            ...
                            <button
                                @click="
                                    actions.deleteSelectedBroadcastProfile()
                                "
                                :disabled="
                                    model.displayActionPending ||
                                    !model.selectedBroadcastProfileId
                                "
                                class="h-11 rounded-xl border border-white/8 bg-black/16 px-4 text-sm font-black tracking-[0.18em] text-white uppercase transition hover:bg-white/7 disabled:cursor-not-allowed disabled:opacity-50"
                            >
                                Delete
                            </button>
                            ...
                            <input
                                ...
                                class="h-11 rounded-xl border border-white/8 bg-black/16 px-4 text-sm font-bold text-white transition outline-none placeholder:text-slate-500"
                            />
                            ...
                            <button
                                ...
                                :disabled="
                                    model.displayActionPending ||
                                    !model.newBroadcastProfileName.trim() ||
                                    (!model.selectedScoreboardDisplayIds
                                        .length &&
                                        !model.selectedRingMatchOrderDisplayIds
                                            .length)
                                "
                                class="h-11 rounded-xl border border-white/8 bg-black/16 px-4 text-sm font-black tracking-[0.18em] text-white uppercase transition hover:bg-white/7 disabled:cursor-not-allowed disabled:opacity-50"
                            >
                        ...
                        <div
                            class="rounded-xl border border-white/6 bg-white/3 px-3 py-2 text-[11px] leading-5 text-slate-400"
                        >
                            <template v-if="selectedBroadcastProfile">
                                {{
                                    selectedBroadcastProfile.scoreboardOutputMode ===
                                    'broadcast'
                                        ? 'Multiple Screens'
                                        : 'Single Screen'
                                }}
                                ...
                                {{
                                    selectedBroadcastProfile
                                        .selectedScoreboardDisplayIds.length
                                }}
                                screen{{
                                    selectedBroadcastProfile
                                        .selectedScoreboardDisplayIds.length ===
                                ...
                                <span
                                    v-if="
                                        selectedBroadcastProfileSnapshots.length
                                    "
                                    class="text-slate-500"
                                >
                                    | Screens:
                                    {{
                                        selectedBroadcastProfileSnapshots
                            ...
                            <template v-else>
                                Save the current screen selection to reuse it at
                                the next event or quickly recover after a
                                restart.
                            </template>
                        </div>
                    </div>
                ...
                <div class="mt-4 grid grid-cols-1 gap-2 sm:grid-cols-3">
                    <div
                        class="rounded-2xl border border-white/7 bg-white/3 px-4 py-3"
                    >
                        <div
                            class="text-[10px] font-black tracking-[0.2em] text-slate-500 uppercase"
                        >
                    ...
                    >
                        ...
                        <div class="mt-1 text-sm font-black text-white">
                            {{ model.selectedScoreboardDisplayIds.length }}
                            screen{{
                                model.selectedScoreboardDisplayIds.length === 1
                                    ? ''
                                    : 's'
                            }}
                        </div>
                    ...
                    >
                        ...
                        <div class="mt-1 text-sm font-black text-white">
                            {{ model.liveScoreboardDisplayIds.length }} screen{{
                                model.liveScoreboardDisplayIds.length === 1
                                    ? ''
                                    : 's'
                            }}
                        </div>
                ...
                <!-- SCOREBOARD STATUS -->
                <div
                    class="mt-4 grid grid-cols-1 gap-3 xl:grid-cols-[minmax(0,1fr)_minmax(0,1.2fr)]"
                >
                    <div
                        class="rounded-3xl border border-cyan-500/20 bg-cyan-500/6 p-4"
                    >
                        <div class="flex flex-wrap items-center gap-2">
                            <div
                                class="text-[10px] font-black tracking-[0.22em] text-cyan-100/80 uppercase"
                            >
                                Controller Screen
                            </div>
                            <span
                                class="rounded-full border border-cyan-400/20 bg-black/10 px-3 py-1 text-[10px] font-black tracking-[0.18em] text-cyan-100 uppercase"
                                >Reference Only</span
                            >
                        </div>
                        <div class="mt-2 text-lg font-black text-white">
                            {{
                                model.controllerDisplayInfo?.label ||
                                'Unavailable'
                            }}
                        </div>
                        <div class="mt-2 max-w-md text-xs text-cyan-50/80">
                            This is the screen running the controller. Usually
                            not used for public output.
                        </div>
                    </div>
                    <div
                        class="rounded-3xl border border-white/7 bg-black/14 p-4"
                    >
                        <div
                        ...
                        >
                            <div>
                                <div
                                    class="text-[10px] font-black tracking-[0.22em] text-slate-500 uppercase"
                                >
                                    Live Status
                                </div>
                                <div
                                ...
                                >
                                    ...
                                    <span
                                        ...
                                        >{{
                                            model.selectedScoreboardDisplayLabel
                                        }}</span
                                    >
                                </div>
                            </div>
                            <div
                                v-if="model.requiresScoreboardDisplaySelection"
                                class="inline-flex rounded-full border border-amber-500/30 bg-amber-500/10 px-3 py-1 text-[10px] font-black tracking-[0.2em] text-amber-100 uppercase"
                            >
                                {{
                                    model.isBroadcastMode
                                        ? 'Choose Screens'
                        ...
                        <div
                            v-if="
                                model.requiresScoreboardDisplaySelection ||
                                model.missingSelectedDisplayIds.length > 0
                            "
                            class="mt-3 text-xs text-slate-500"
                        >
                            {{ model.selectedScoreboardDisplayDescription }}
                        </div>
                        <div class="mt-2 text-sm text-slate-300">
                            {{ model.scoreboardStatusDescription }}
                        </div>
                    </div>
                </div>
                ...
                >
                    <div class="min-w-0">
                        {{
                            model.displayErrorMessage ||
                            model.displayState.statusNotice?.message
                        }}
                    </div>
                </div>
                ...
                >
                    <div>
                        Controller Screen is currently selected as a scoreboard
                        output. Launching here will also show the public
                        scoreboard on the controller screen.
                    </div>
                    <label
                        class="mt-3 flex items-start gap-3 rounded-2xl border border-amber-500/20 bg-black/10 px-3 py-3 text-xs text-amber-50"
                    >
                        <input
                        ...
                        />
                        <span
                            >I understand and want to include Controller Screen
                            in the public scoreboard output.</span
                        >
                    </label>
                </div>
                ...
                >
                    ...
                    >
                        <div>
                            <div
                                class="text-sm font-black tracking-[0.18em] text-white uppercase"
                            >
                                Unavailable Selected Screens
                            </div>
                            <div class="mt-1 text-xs text-slate-400">
                                These screens are still part of the saved
                                selection, but they are not currently available
                                in the current display layout.
                            </div>
                        </div>
                        <div class="text-xs text-slate-400">
                            Reconnect them later to re-add them to the live
                            output.
                        </div>
                    </div>
                        ...
                        >
                            ...
                            >
                                <div>
                                    ...
                                    >
                                        {{ missingDisplay.label }}
                                    </div>
                                    <div
                                        v-if="model.isDisplayAdvancedOpen"
                                        class="mt-1 font-mono text-xs text-slate-500"
                                    >
                                        id={{ missingDisplay.id }}
                                    </div>
                                </div>
                                <div
                                    class="flex flex-wrap gap-2 text-[10px] font-black tracking-[0.18em] uppercase"
                                >
                                    <span
                            ...
                            <div class="mt-3 text-xs text-slate-400">
                                Keep this saved if the screen should return
                                later, or remove it from the selection now.
                            </div>
                            <div class="mt-3">
                                <button
                                    @click="
                                        actions.removeDisplayTarget(
                                            missingDisplay.id,
                                        )
                                    "
                                    :disabled="
                ...
                >
                    Version 1 is tuned for 2 to 4 live outputs. This selection
                    may work, but it goes beyond the recommended first-release
                    range.
                </div>

                <div
                    class="mt-5 rounded-4xl border border-white/8 bg-black/22 p-5 shadow-[0_24px_70px_-56px_rgba(15,23,42,0.92)]"
                >
                    <div
                        class="flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between"
                    >
                        <div>
                            ...
                            <div class="mt-1 text-xs text-slate-400">
                                Select the screens that should receive the
                                scoreboard.
                            </div>
                            <div class="mt-2 text-xs text-slate-500">
                                {{
                                    model.isBroadcastMode
                                        ? 'Choose every screen that should show the synchronized public board.'
                                        : 'Choose the single screen that should show the public board.'
                                }}
                            </div>
                        </div>
                        <div class="flex flex-wrap gap-2">
                            <button
                                ...
                                @click="
                                    actions.selectAllExternalDisplayTargets()
                                "
                                :disabled="
                                    model.displayActionPending ||
                                    model.isScoreboardLive ||
                    ...
                    >
                        <div
                            class="text-sm font-black tracking-[0.18em] text-white uppercase"
                        >
                            No Screens Detected Yet
                        </div>
                        <div class="mt-2 text-xs text-slate-400">
                            Connect another monitor or use Re-scan screens to
                            refresh the list.
                        </div>
                    </div>
                    ...
                    >
                        <div
                            ...
                            @click="
                                ...
                                model.isDisplayTestActive
                                    ? null
                                    : actions.toggleScoreboardTarget(display.id)
                            "
                            class="rounded-3xl border p-4 text-left transition"
                            :class="
                                model.getDisplayStatusEntry(display.id).selected
                        ...
                        >
                            ...
                            >
                                <div class="min-w-0">
                                    ...
                                    <div class="mt-1 text-xs text-slate-400">
                                        {{ model.getDisplayRoleLabel(display) }}
                                    </div>
                                </div>
                                <div
                                    class="flex flex-wrap gap-2 text-[10px] font-black tracking-[0.18em] uppercase"
                                >
                                    ...
                                    <span
                                        v-for="usage in model.getDisplayRoleUsageBadges(
                                            display.id,
                                        )"
                            ...
                            <div
                                v-if="
                                    model.isBroadcastMode &&
                                    model.isScoreboardLive &&
                                    model.getDisplayStatusEntry(display.id)
                                        .selected &&
                                    !model.getDisplayStatusEntry(display.id)
                                        .live &&
                                    !model.getDisplayStatusEntry(display.id)
                            ...
                            >
                                <button
                                    @click.stop="
                                        actions.reAddDisplayToBroadcast(
                                            display.id,
                                        )
                                    "
                                    :disabled="
                ...
                <div
                    class="mt-5 rounded-3xl border border-white/7 bg-black/18 p-4"
                >
                    <div
                    ...
                    >
                        <div>
                            ...
                            <div class="mt-1 text-xs text-slate-400">
                                {{
                                    model.isScoreboardLive ||
                                    model.isDisplayTestActive
                                        ? 'Monitor status or stop the current output when you are done.'
                                        : 'Launch is the primary next step after mode and screen selection.'
                                }}
                            </div>
                            <div class="mt-2 text-xs text-slate-500">
                                {{ model.selectedScoreboardDisplayDescription }}
                        ...
                        <div class="flex flex-wrap gap-3">
                            ...
                            >
                                <button
                                    ...
                                    :disabled="
                                        ...
                                        !model.selectedScoreboardDisplayIds
                                            .length ||
                                        model.requiresControllerOutputConfirmation
                                    "
                                    class="h-12 rounded-2xl border border-white/10 bg-black/20 px-5 text-sm font-black tracking-[0.18em] text-white uppercase transition hover:bg-white/8 disabled:cursor-not-allowed disabled:opacity-50"
                                >
                                    {{
                                        model.isBroadcastMode
                                            ? 'Test Selected Screens'
                                            : 'Test Screen'
                                    }}
                                </button>
                                <button
                                    ...
                                    :disabled="
                                        ...
                                        model.requiresControllerOutputConfirmation
                                    "
                                    class="h-12 rounded-2xl bg-blue-600 px-6 text-sm font-black tracking-[0.18em] text-white uppercase shadow-[0_18px_45px_-28px_rgba(37,99,235,0.95)] transition hover:bg-blue-500 disabled:cursor-not-allowed disabled:opacity-50"
                                >
                                    {{
                                        model.displayActionPending
                                            ? 'Launching...'
                            ...
                            <button
                                ...
                                :disabled="model.displayActionPending"
                                class="h-12 rounded-2xl bg-rose-600 px-6 text-sm font-black tracking-[0.18em] text-white uppercase shadow-[0_18px_45px_-28px_rgba(225,29,72,0.95)] transition hover:bg-rose-500 disabled:cursor-not-allowed disabled:opacity-50"
                            >
                                {{
                                    model.isBroadcastMode
                                        ? 'Stop Broadcast'
                ...
                <div
                    class="mt-6 rounded-4xl border border-cyan-500/18 bg-cyan-500/6 p-5 shadow-[0_24px_70px_-56px_rgba(8,145,178,0.75)]"
                >
                    <button
                        ...
                        :aria-expanded="
                            model.isRingMatchOrderPanelExpanded
                                ? 'true'
                                : 'false'
                        "
                    >
                        <div class="min-w-0 flex-1">
                            <div class="flex flex-wrap items-center gap-2">
                                <span
                                    class="rounded-full border border-cyan-500/30 bg-cyan-500/10 px-3 py-1 text-[10px] font-black tracking-[0.2em] text-cyan-100 uppercase"
                                    >Gilam Match Order</span
                                >
                                <span
                                    class="rounded-full border px-3 py-1 text-[10px] font-black tracking-[0.2em] uppercase"
                                ...
                                <span
                                    class="rounded-full border px-3 py-1 text-[10px] font-black tracking-[0.2em] uppercase"
                                    :class="
                                        model.ringMatchOrderProjectionFreshnessToneClass
                                    "
                                >
                                    {{
                                ...
                                <span
                                    class="rounded-full border border-white/10 bg-white/5 px-3 py-1 text-[10px] font-black tracking-[0.2em] text-slate-200 uppercase"
                                >
                                    Selected
                                    {{
                                        model.selectedRingMatchOrderDisplayIds
                                ...
                                >
                                    Live
                                    {{
                                        model.liveRingMatchOrderDisplayIds
                                            .length
                                    }}
                                </span>
                                <span
                                    v-if="
                                        model.requiresRingMatchOrderDisplaySelection
                                    "
                                    class="rounded-full border border-amber-500/30 bg-amber-500/10 px-3 py-1 text-[10px] font-black tracking-[0.2em] text-amber-100 uppercase"
                                >
                                    {{
                                        model.isBroadcastMode
                                            ? 'Choose Screens'
                            ...
                            <h4
                                class="mt-2 text-lg font-black tracking-[0.16em] text-white uppercase"
                            >
                                Gilam Match Order
                            </h4>
                            <div class="mt-2 max-w-3xl text-xs text-slate-300">
                                {{ model.ringMatchOrderStatusDescription }}
                            </div>
                        </div>
                        <div class="flex shrink-0 items-center gap-2">
                            <div
                                class="flex h-10 w-10 items-center justify-center rounded-2xl border border-white/10 bg-white/5"
                            >
                                <ChevronDownIcon
                                    :class="`h-5 w-5 text-slate-300 transition-transform duration-300 ${model.isRingMatchOrderPanelExpanded ? 'rotate-180' : ''}`"
                                />
                            </div>
                        </div>
                    </button>
                    ...
                    <div
                        v-if="model.isRingMatchOrderPanelExpanded"
                        class="mt-4 border-t border-cyan-500/15 pt-4"
                    >
                        <div class="mb-4 text-xs text-cyan-50/75">
                            Local screens for the Event Host gilam projection.
                            Freshness here is snapshot age only.
                        </div>
                        ...
                        <div class="mt-4 grid grid-cols-1 gap-3">
                            ...
                            >
                                    ...
                                    <div>
                                        ...
                                        >
                                            <span
                                                class="rounded-full border px-3 py-1 text-[10px] font-black tracking-[0.2em] uppercase"
                                                :class="
                                                    model.ringMatchOrderStatusToneClass
                                                "
                                            >
                                                {{
                                                    model.ringMatchOrderStatusLabel
                                            ...
                                            <span
                                                class="text-xs font-bold text-slate-300"
                                                >{{
                                                    model.selectedRingMatchOrderDisplayLabel
                                                }}</span
                                            >
                                        </div>
                                    </div>
                                ...
                                <div
                                    v-if="
                                        model.requiresRingMatchOrderDisplaySelection ||
                                        model.missingRingMatchOrderDisplayIds
                                            .length > 0
                                    "
                                    class="mt-3 text-xs text-slate-500"
                                >
                                    {{
                                        model.selectedRingMatchOrderDisplayDescription
                                    }}
                                </div>
                                <div class="mt-2 text-sm text-slate-300">
                                    {{ model.ringMatchOrderStatusDescription }}
                        ...
                        <div
                            v-if="
                                model.missingRingMatchOrderDisplayEntries
                                    .length > 0
                            "
                            class="mt-4 rounded-3xl border border-white/7 bg-black/16 p-4"
                        >
                            ...
                            >
                                <div>
                                    ...
                                    <div class="mt-1 text-xs text-slate-400">
                                        Saved Gilam Match Order screens that are
                                        not available in the current display
                                        layout.
                                    </div>
                                </div>
                                <div class="text-xs text-slate-400">
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div class="mt-3 text-xs text-slate-400">
                                        Keep this selection if the screen should
                                        return later, or remove it now.
                                    </div>
                                    <div class="mt-3">
                                        <button
                                            @click="
                                                actions.removeRingMatchOrderDisplayTarget(
                                                    missingDisplay.id,
                                                )
                                            "
                                            :disabled="
                        ...
                        >
                            ...
                            >
                                <div>
                                    ...
                                    <div class="mt-1 text-xs text-slate-400">
                                        {{
                                            model.isBroadcastMode
                                                ? "Choose the screens that should show this controller's Gilam Match Order feed."
                                                : "Choose the screen that should show this controller's Gilam Match Order feed."
                                        }}
                                    </div>
                                    <div class="mt-2 text-xs text-slate-500">
                                        {{
                                            model.isBroadcastMode
                                                ? 'One projection payload fans out to every selected screen.'
                                                : 'Single Screen mode keeps this role to one selected display.'
                                        }}
                                    </div>
                                </div>
                                <div class="flex flex-wrap gap-2">
                                    <button
                                        v-if="model.isBroadcastMode"
                                        @click="
                                            actions.selectAllRingMatchOrderDisplayTargets()
                                        "
                                        :disabled="
                                            model.displayActionPending ||
                                            model.isRingMatchOrderLive ||
                                    ...
                                    <button
                                        @click="
                                            actions.clearRingMatchOrderDisplayTargets()
                                        "
                                        :disabled="
                                            model.displayActionPending ||
                                            model.isRingMatchOrderLive ||
                            ...
                            >
                                ...
                                <div class="mt-2 text-xs text-slate-400">
                                    Connect another monitor or re-scan screens
                                    to refresh the list.
                                </div>
                            </div>
                            ...
                            >
                                <div
                                    ...
                                    @click="
                                        ...
                                        model.isRingMatchOrderPreviewActive
                                            ? null
                                            : actions.toggleRingMatchOrderTarget(
                                                  display.id,
                                              )
                                    "
                                    class="rounded-3xl border p-4 text-left transition"
                                    :class="
                                        model.getDisplayStatusEntryForRole(
                                            'ring_match_order',
                                            display.id,
                                        ).selected
                                ...
                                >
                                    ...
                                    <div class="mt-3 text-xs text-slate-400">
                                        {{
                                            model.getRingMatchOrderDisplayCardDescription(
                                                display.id,
                                            )
                                        }}
                                    </div>
                                    ...
                                    >
                                        <button
                                            @click.stop="
                                                actions.reAddRingMatchOrderOutput(
                                                    display.id,
                                                )
                                            "
                                            :disabled="
                            ...
                            >
                                ...
                                <div class="flex flex-wrap gap-3">
                                    ...
                                    >
                                        <button
                                            @click="
                                                actions.previewSelectedRingMatchOrderDisplays()
                                            "
                                            :disabled="
                                                model.displayActionPending ||
                                                !model
                                        ...
                                        <button
                                            @click="
                                                actions.launchSelectedRingMatchOrderDisplays()
                                            "
                                            :disabled="
                                                model.displayActionPending ||
                                                !model
                                    ...
                                    <button
                                        v-else
                                        @click="
                                            actions.stopRingMatchOrderOutputs()
                                        "
                                        :disabled="model.displayActionPending"
                                        class="h-12 rounded-2xl bg-rose-600 px-6 text-sm font-black tracking-[0.18em] text-white uppercase shadow-[0_18px_45px_-28px_rgba(225,29,72,0.95)] transition hover:bg-rose-500 disabled:cursor-not-allowed disabled:opacity-50"
                                    >
                ...
                <div
                    class="mt-5 rounded-3xl border border-white/6 bg-black/12 p-4"
                >
                    <button
                        ...
                        :aria-expanded="
                            model.isDisplayAdvancedOpen ? 'true' : 'false'
                        "
                    >
                        <div>
                            <div
                            ...
                            <div class="mt-1 text-xs text-slate-400">
                                Technical diagnostics and recovery actions.
                            </div>
                        </div>
                        <div
                            class="flex h-10 w-10 items-center justify-center rounded-2xl border border-white/10 bg-white/5"
                        >
                            <ChevronDownIcon
                                :class="`h-5 w-5 text-slate-300 transition-transform duration-300 ${model.isDisplayAdvancedOpen ? 'rotate-180' : ''}`"
                            />
                        </div>
                    </button>
                    ...
                    >
                        <div class="flex flex-wrap gap-3">
                            <button
                                @click="
                                    actions.moveControllerToSelectedDisplay()
                                "
                                :disabled="
                                    model.displayActionPending ||
                                    !model.selectedScoreboardDisplayId ||
                                    model.isDisplayTestActive
                                "
                        ...
                        <div
                            class="rounded-3xl border border-cyan-500/25 bg-black/18 p-4"
                        >
                            <div class="flex flex-wrap items-center gap-2">
                                <div
                                    class="text-[10px] font-black tracking-[0.22em] text-cyan-100/80 uppercase"
                                >
                                    Gilam Match Order Feed
                                </div>
                                <span
                                    class="rounded-full border border-white/10 bg-white/5 px-3 py-1 text-[10px] font-black tracking-[0.18em] text-slate-200 uppercase"
                                >
                                    Fresh
                                    {{ model.ringMatchOrderFreshSeconds }}s /
                                    Offline
                                    {{ model.ringMatchOrderOfflineSeconds }}s
                                </span>
                            </div>
                            <div class="mt-3 grid gap-3 sm:grid-cols-2">
                                ...
                                >
                                    ...
                                    >
                                        {{
                                            model.ringMatchOrderProjectionLastUpdatedLabel
                                        }}
                                    </div>
                                </div>
                                <div
                                ...
                                >
                                    ...
                                    >
                                        {{
                                            model.ringMatchOrderProjectionLastAttemptLabel
                                        }}
                                    </div>
                                </div>
                            </div>
                            <div class="mt-3 text-xs text-slate-400">
                                {{
                                    model.ringMatchOrderProjectionStatusSummary
                                }}
                            </div>
                            <div
                                v-if="
                                    model.ringMatchOrderProjectionRecord
                                        ?.lastError
                                "
                        ...
                        <div
                            class="rounded-2xl border border-white/7 bg-slate-950/28 p-4"
                        >
                            <div
                                class="flex flex-col gap-2 md:flex-row md:items-center md:justify-between"
                            >
                                ...
                                >
                                    ...
                                    {{
                                        ...
                                        model.liveScoreboardDisplayIds.length
                                    }}
                                    | Gilam Match Order
                                    {{
                                        model.selectedRingMatchOrderDisplayIds
                                        ...
                                        model.liveRingMatchOrderDisplays.length
                                    }}
                                    | Mode {{ model.displayModeLabel }}
                                </div>
                            </div>
                            ...
                            <div class="mt-4 space-y-3">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <div
                                            class="flex flex-wrap gap-2 text-[10px] font-black tracking-wider uppercase"
                                        >
                                            <span
                                                v-if="display.isPrimary"
                                    ...
                                    <div
                                        class="mt-3 flex flex-wrap gap-x-3 gap-y-1 font-mono text-[11px] text-slate-300"
                                    >
                                        <span>id={{ display.id }}</span>
                                        <span
                                            >bounds={{ display.bounds.x }},{{
                                                display.bounds.y
                                            }}
...
interface RefereeDisplayManagementPanelModel {
    ...
    getDisplayStatusEntryForRole: (
        role: ElectronDisplayRole,
        displayId: string,
    ) => ElectronPerDisplayStatus;
    getProfileDisplaySnapshots: (
        profile: ElectronBroadcastProfile,
...
function handleBroadcastProfileNameInput(event: Event) {
    actions.setNewBroadcastProfileName(
        (event.target as HTMLInputElement).value,
    );
}

function handleControllerOutputConfirmedChange(event: Event) {
    actions.setControllerOutputConfirmed(
