  ...
  <div class="rounded-3xl border border-emerald-400/15 bg-black/30 p-5 shadow-xl shadow-black/10">
    <div class="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
      <div class="min-w-0">
        ...
        <div class="mt-2 text-xl font-black text-white">Pair this controller to the Event Host.</div>
        <div class="mt-2 max-w-2xl text-sm font-semibold leading-6 text-slate-400">
          Use the Event Host code once. Reconnect is automatic after pairing.
        </div>
      </div>
    ...
    <div class="mt-5 grid gap-4">
      ...
      <details class="rounded-2xl border border-white/8 bg-white/3 px-4 py-3">
        <summary class="cursor-pointer list-none text-[10px] font-black uppercase tracking-[0.2em] text-slate-400">
        ...
        <div class="mt-3">
          ...
          />
          <div class="mt-2 text-[11px] font-semibold leading-5 text-slate-400">
            Support-only. Pairing, reconnect, and Admin Recovery share this host.
          </div>
        </div>
      </details>
